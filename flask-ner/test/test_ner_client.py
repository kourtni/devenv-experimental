...
class TestNerClient(unittest.TestCase):
    ...
    def test_get_entities_returns_dictionary_given_empty_string_causes_empty_spacy_doc_ents(
            self):
    ...
    def test_get_entities_returns_dict_given_nonempty_string_causes_empty_spacy_doc_ents(
            self):
        model = NerModelTestDouble('eng')
        model.returns_doc_entities([])
        ner = NamedEntityClient(model)
    ...
    @parameterized.expand([
        ('person_to_person', 'Laurent Fressinet', 'PERSON', 'Person'),
